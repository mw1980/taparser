...
import org.mrr.specification.DefaultCodeSpecificationLogic;
...
class Main_temp {
    public static void main(final String[] args) {
        ...
        final CodeSpecificationLogic specificationParser = context.getBean("defaultCodeSpecificationLogic", DefaultCodeSpecificationLogic.class);
