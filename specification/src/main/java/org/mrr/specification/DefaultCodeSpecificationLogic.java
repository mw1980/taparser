...
@Component
public class DefaultCodeSpecificationLogic implements CodeSpecificationLogic {
    ...
    @Autowired
    public DefaultCodeSpecificationLogic(final ParseActionLogic parseActionLogic,
